 ...
 * アナウンスアクティビティを捌きます
 */
export default async function(resolver: Resolver, actor: RemoteUser, activity: IAnnounce, note: IObject): Promise<void> {
...
function getVisibility(to: string[], cc: string[], actor: RemoteUser): visibility {
